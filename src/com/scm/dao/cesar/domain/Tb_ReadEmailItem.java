...
/**
 * The persistent class for the tb_ReadEmailItems database table.
 * 
 */
@Entity
@Table(name="tb_ReadEmailItems")
@NamedQuery(name="Tb_ReadEmailItem.findAll", query="SELECT t FROM Tb_ReadEmailItem t")
public class Tb_ReadEmailItem implements Serializable {
