...
public class PfmaSchedule implements Serializable {
	...
	@Column(name="PfmaScheduleId")
	private int pfmaScheduleId;
	...
	public int getPfmaScheduleId() {
		return this.pfmaScheduleId;
	}

	public void setPfmaScheduleId(int pfmaScheduleId) {
