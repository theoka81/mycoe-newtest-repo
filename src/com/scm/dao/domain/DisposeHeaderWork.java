...
/**
 * The persistent class for the DisposeHeaderWorks database table.
 * 
 */
@Entity
@Table(name="DisposeHeaderWorks")
@NamedQuery(name="DisposeHeaderWork.findAll", query="SELECT d FROM DisposeHeaderWork d")
public class DisposeHeaderWork implements Serializable {
