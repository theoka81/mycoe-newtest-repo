...
/**
 * The persistent class for the ContractClauseAudits database table.
 * 
 */
@Entity
@Table(name="ContractClauseAudits")
@NamedQuery(name="ContractClauseAudit.findAll", query="SELECT c FROM ContractClauseAudit c")
public class ContractClauseAudit implements Serializable {
