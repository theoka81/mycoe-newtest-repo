...
/**
 * The persistent class for the WarehouseInventoryDefinitions database table.
 * 
 */
@Entity
@Table(name="WarehouseInventoryDefinitions")
@NamedQuery(name="WarehouseInventoryDefinition.findAll", query="SELECT w FROM WarehouseInventoryDefinition w")
public class WarehouseInventoryDefinition implements Serializable {
	...
	@Column(name="WarehouseItemStatus")
	...
	public WarehouseInventoryDefinition() {
	}
	...
	public String getWarehouseItemStatus() {
		return this.warehouseItemStatus;
	}
