...
/**
 * The persistent class for the SupplierCodes database table.
 * 
 */
@Entity
@Table(name="SupplierCodes")
@NamedQuery(name="SupplierCode.findAll", query="SELECT s FROM SupplierCode s")
public class SupplierCode implements Serializable {
