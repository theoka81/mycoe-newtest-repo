...
/**
 * The persistent class for the UserCode01 database table.
 * 
 */
@Entity
@Table(name="UserCode01")
@NamedQuery(name="UserCode01.findAll", query="SELECT u FROM UserCode01 u")
public class UserCode01 implements Serializable {
