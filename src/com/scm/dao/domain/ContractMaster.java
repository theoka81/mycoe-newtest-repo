...
/**
 * The persistent class for the ContractMasters database table.
 * 
 */
@Entity
@Table(name="ContractMasters")
...
public class ContractMaster implements Serializable {
	...
	@OneToMany(mappedBy="contractMaster")
	...
	//bi-directional many-to-one association to ContractDetailsAudit
	@OneToMany(mappedBy="contractMaster")
	private Set<ContractDetailsAudit> contractDetailsAudits;

	//bi-directional many-to-one association to ContractDetailsWorkAudit
	@OneToMany(mappedBy="contractMaster")
	private Set<ContractDetailsWorkAudit> contractDetailsWorkAudits;

	//bi-directional many-to-one association to ContractDetailsWork
	@OneToMany(mappedBy="contractMaster")
	private Set<ContractDetailsWork> contractDetailsWorks;
	...
	public ContractClauseAudit addContractClauseAudit(ContractClauseAudit contractClauseAudit) {
		...
		contractClauseAudit.setContractMaster(this);
	...
	public ContractClauseAudit removeContractClauseAudit(ContractClauseAudit contractClauseAudit) {
		...
		contractClauseAudit.setContractMaster(null);
	...
	public ContractClause addContractClaus(ContractClause contractClaus) {
		...
		contractClaus.setContractMaster(this);
	...
	public ContractClause removeContractClaus(ContractClause contractClaus) {
		...
		contractClaus.setContractMaster(null);
	...
	public ContractDetail addContractDetail(ContractDetail contractDetail) {
		...
		contractDetail.setContractMaster(this);
	...
	public ContractDetail removeContractDetail(ContractDetail contractDetail) {
		...
		contractDetail.setContractMaster(null);

		return contractDetail;
	}

	public Set<ContractDetailsAudit> getContractDetailsAudits() {
		return this.contractDetailsAudits;
	}

	public void setContractDetailsAudits(Set<ContractDetailsAudit> contractDetailsAudits) {
		this.contractDetailsAudits = contractDetailsAudits;
	}

	public ContractDetailsAudit addContractDetailsAudit(ContractDetailsAudit contractDetailsAudit) {
		getContractDetailsAudits().add(contractDetailsAudit);
		contractDetailsAudit.setContractMaster(this);

		return contractDetailsAudit;
	}

	public ContractDetailsAudit removeContractDetailsAudit(ContractDetailsAudit contractDetailsAudit) {
		getContractDetailsAudits().remove(contractDetailsAudit);
		contractDetailsAudit.setContractMaster(null);

		return contractDetailsAudit;
	}

	public Set<ContractDetailsWorkAudit> getContractDetailsWorkAudits() {
		return this.contractDetailsWorkAudits;
	}

	public void setContractDetailsWorkAudits(Set<ContractDetailsWorkAudit> contractDetailsWorkAudits) {
		this.contractDetailsWorkAudits = contractDetailsWorkAudits;
	}

	public ContractDetailsWorkAudit addContractDetailsWorkAudit(ContractDetailsWorkAudit contractDetailsWorkAudit) {
		getContractDetailsWorkAudits().add(contractDetailsWorkAudit);
		contractDetailsWorkAudit.setContractMaster(this);

		return contractDetailsWorkAudit;
	}

	public ContractDetailsWorkAudit removeContractDetailsWorkAudit(ContractDetailsWorkAudit contractDetailsWorkAudit) {
		getContractDetailsWorkAudits().remove(contractDetailsWorkAudit);
		contractDetailsWorkAudit.setContractMaster(null);

		return contractDetailsWorkAudit;
	}

	public Set<ContractDetailsWork> getContractDetailsWorks() {
		return this.contractDetailsWorks;
	}

	public void setContractDetailsWorks(Set<ContractDetailsWork> contractDetailsWorks) {
		this.contractDetailsWorks = contractDetailsWorks;
	}

	public ContractDetailsWork addContractDetailsWork(ContractDetailsWork contractDetailsWork) {
		getContractDetailsWorks().add(contractDetailsWork);
		contractDetailsWork.setContractMaster(this);

		return contractDetailsWork;
	}

	public ContractDetailsWork removeContractDetailsWork(ContractDetailsWork contractDetailsWork) {
		getContractDetailsWorks().remove(contractDetailsWork);
		contractDetailsWork.setContractMaster(null);
