...
/**
 * The persistent class for the ContractDetailsWorks database table.
 * 
 */
@Entity
@Table(name="ContractDetailsWorks")
@NamedQuery(name="ContractDetailsWork.findAll", query="SELECT c FROM ContractDetailsWork c")
public class ContractDetailsWork implements Serializable {
