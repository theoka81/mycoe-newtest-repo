...
/**
 * The persistent class for the StandardAgreementWorkAudits database table.
 * 
 */
@Entity
@Table(name="StandardAgreementWorkAudits")
@NamedQuery(name="StandardAgreementWorkAudit.findAll", query="SELECT s FROM StandardAgreementWorkAudit s")
public class StandardAgreementWorkAudit implements Serializable {
	...
	public StandardAgreementWorkAudit() {
	}
