...
/**
 * The persistent class for the BenchmarkLinkedCommoditiesAudits database table.
 * 
 */
@Entity
@Table(name="BenchmarkLinkedCommoditiesAudits")
@NamedQuery(name="BenchmarkLinkedCommoditiesAudit.findAll", query="SELECT b FROM BenchmarkLinkedCommoditiesAudit b")
public class BenchmarkLinkedCommoditiesAudit implements Serializable {
	...
	public BenchmarkLinkedCommoditiesAudit() {
	}
