...
/**
 * The persistent class for the InventoryCodeAudits database table.
 * 
 */
@Entity
@Table(name="InventoryCodeAudits")
@NamedQuery(name="InventoryCodeAudit.findAll", query="SELECT i FROM InventoryCodeAudit i")
public class InventoryCodeAudit implements Serializable {
