...
/**
 * The persistent class for the InventoryDefinitions database table.
 * 
 */
@Entity
@Table(name="InventoryDefinitions")
@NamedQuery(name="InventoryDefinition.findAll", query="SELECT i FROM InventoryDefinition i")
public class InventoryDefinition implements Serializable {
	...
	//bi-directional many-to-one association to CycleCountDetail
	@OneToMany(mappedBy="inventoryDefinition")
	...
	//bi-directional many-to-one association to InventoryCodeAudit
	@OneToMany(mappedBy="inventoryDefinition")
	private Set<InventoryCodeAudit> inventoryCodeAudits;

	//bi-directional many-to-one association to InventoryCode
	@OneToMany(mappedBy="inventoryDefinition")
	private Set<InventoryCode> inventoryCodes;

	//bi-directional many-to-one association to InventoryCodesWorkAudit
	@OneToMany(mappedBy="inventoryDefinition")
	private Set<InventoryCodesWorkAudit> inventoryCodesWorkAudits;

	//bi-directional many-to-one association to InventoryCodesWork
	@OneToMany(mappedBy="inventoryDefinition")
	private Set<InventoryCodesWork> inventoryCodesWorks;

	//bi-directional many-to-one association to InventoryCode
	@ManyToOne
	@JoinColumn(name="InventoryCode_Id")
	private InventoryCode inventoryCode;

	//bi-directional many-to-one association to InventoryPricingAudit
	@OneToMany(mappedBy="inventoryDefinition")
	private Set<InventoryPricingAudit> inventoryPricingAudits;

	//bi-directional many-to-one association to InventoryPricing
	@OneToMany(mappedBy="inventoryDefinition")
	private Set<InventoryPricing> inventoryPricings;

	//bi-directional many-to-one association to InventoryWarehouseDefault
	@OneToMany(mappedBy="inventoryDefinition")
	private Set<InventoryWarehouseDefault> inventoryWarehouseDefaults;

	//bi-directional many-to-one association to InventoryWarehouseDefaultsAudit
	@OneToMany(mappedBy="inventoryDefinition")
	private Set<InventoryWarehouseDefaultsAudit> inventoryWarehouseDefaultsAudits;

	//bi-directional many-to-one association to ItemBalance
	@OneToMany(mappedBy="inventoryDefinition")
	private Set<ItemBalance> itemBalances;
	...
	public CycleCountDetail addCycleCountDetail(CycleCountDetail cycleCountDetail) {
		getCycleCountDetails().add(cycleCountDetail);
		cycleCountDetail.setInventoryDefinition(this);

		return cycleCountDetail;
	}

	public CycleCountDetail removeCycleCountDetail(CycleCountDetail cycleCountDetail) {
		getCycleCountDetails().remove(cycleCountDetail);
		cycleCountDetail.setInventoryDefinition(null);
	...
	public DisposeDetail addDisposeDetail(DisposeDetail disposeDetail) {
		...
		disposeDetail.setInventoryDefinition(this);
	...
	public DisposeDetail removeDisposeDetail(DisposeDetail disposeDetail) {
		...
		disposeDetail.setInventoryDefinition(null);

		return disposeDetail;
	}

	public Set<InventoryCodeAudit> getInventoryCodeAudits() {
		return this.inventoryCodeAudits;
	}

	public void setInventoryCodeAudits(Set<InventoryCodeAudit> inventoryCodeAudits) {
		this.inventoryCodeAudits = inventoryCodeAudits;
	}

	public InventoryCodeAudit addInventoryCodeAudit(InventoryCodeAudit inventoryCodeAudit) {
		getInventoryCodeAudits().add(inventoryCodeAudit);
		inventoryCodeAudit.setInventoryDefinition(this);

		return inventoryCodeAudit;
	}

	public InventoryCodeAudit removeInventoryCodeAudit(InventoryCodeAudit inventoryCodeAudit) {
		getInventoryCodeAudits().remove(inventoryCodeAudit);
		inventoryCodeAudit.setInventoryDefinition(null);

		return inventoryCodeAudit;
	}

	public Set<InventoryCode> getInventoryCodes() {
		return this.inventoryCodes;
	}

	public void setInventoryCodes(Set<InventoryCode> inventoryCodes) {
		this.inventoryCodes = inventoryCodes;
	}

	public InventoryCode addInventoryCode(InventoryCode inventoryCode) {
		getInventoryCodes().add(inventoryCode);
		inventoryCode.setInventoryDefinition(this);

		return inventoryCode;
	}

	public InventoryCode removeInventoryCode(InventoryCode inventoryCode) {
		getInventoryCodes().remove(inventoryCode);
		inventoryCode.setInventoryDefinition(null);

		return inventoryCode;
	}

	public Set<InventoryCodesWorkAudit> getInventoryCodesWorkAudits() {
		return this.inventoryCodesWorkAudits;
	}

	public void setInventoryCodesWorkAudits(Set<InventoryCodesWorkAudit> inventoryCodesWorkAudits) {
		this.inventoryCodesWorkAudits = inventoryCodesWorkAudits;
	}

	public InventoryCodesWorkAudit addInventoryCodesWorkAudit(InventoryCodesWorkAudit inventoryCodesWorkAudit) {
		getInventoryCodesWorkAudits().add(inventoryCodesWorkAudit);
		inventoryCodesWorkAudit.setInventoryDefinition(this);

		return inventoryCodesWorkAudit;
	}

	public InventoryCodesWorkAudit removeInventoryCodesWorkAudit(InventoryCodesWorkAudit inventoryCodesWorkAudit) {
		getInventoryCodesWorkAudits().remove(inventoryCodesWorkAudit);
		inventoryCodesWorkAudit.setInventoryDefinition(null);

		return inventoryCodesWorkAudit;
	}

	public Set<InventoryCodesWork> getInventoryCodesWorks() {
		return this.inventoryCodesWorks;
	}

	public void setInventoryCodesWorks(Set<InventoryCodesWork> inventoryCodesWorks) {
		this.inventoryCodesWorks = inventoryCodesWorks;
	}

	public InventoryCodesWork addInventoryCodesWork(InventoryCodesWork inventoryCodesWork) {
		getInventoryCodesWorks().add(inventoryCodesWork);
		inventoryCodesWork.setInventoryDefinition(this);

		return inventoryCodesWork;
	}

	public InventoryCodesWork removeInventoryCodesWork(InventoryCodesWork inventoryCodesWork) {
		getInventoryCodesWorks().remove(inventoryCodesWork);
		inventoryCodesWork.setInventoryDefinition(null);
	...
	public Set<InventoryPricingAudit> getInventoryPricingAudits() {
		return this.inventoryPricingAudits;
	}

	public void setInventoryPricingAudits(Set<InventoryPricingAudit> inventoryPricingAudits) {
		this.inventoryPricingAudits = inventoryPricingAudits;
	}

	public InventoryPricingAudit addInventoryPricingAudit(InventoryPricingAudit inventoryPricingAudit) {
		getInventoryPricingAudits().add(inventoryPricingAudit);
		inventoryPricingAudit.setInventoryDefinition(this);

		return inventoryPricingAudit;
	}

	public InventoryPricingAudit removeInventoryPricingAudit(InventoryPricingAudit inventoryPricingAudit) {
		getInventoryPricingAudits().remove(inventoryPricingAudit);
		inventoryPricingAudit.setInventoryDefinition(null);

		return inventoryPricingAudit;
	}

	public Set<InventoryPricing> getInventoryPricings() {
		return this.inventoryPricings;
	}

	public void setInventoryPricings(Set<InventoryPricing> inventoryPricings) {
		this.inventoryPricings = inventoryPricings;
	}

	public InventoryPricing addInventoryPricing(InventoryPricing inventoryPricing) {
		getInventoryPricings().add(inventoryPricing);
		inventoryPricing.setInventoryDefinition(this);

		return inventoryPricing;
	}

	public InventoryPricing removeInventoryPricing(InventoryPricing inventoryPricing) {
		getInventoryPricings().remove(inventoryPricing);
		inventoryPricing.setInventoryDefinition(null);

		return inventoryPricing;
	}

	public Set<InventoryWarehouseDefault> getInventoryWarehouseDefaults() {
		return this.inventoryWarehouseDefaults;
	}

	public void setInventoryWarehouseDefaults(Set<InventoryWarehouseDefault> inventoryWarehouseDefaults) {
		this.inventoryWarehouseDefaults = inventoryWarehouseDefaults;
	}

	public InventoryWarehouseDefault addInventoryWarehouseDefault(InventoryWarehouseDefault inventoryWarehouseDefault) {
		getInventoryWarehouseDefaults().add(inventoryWarehouseDefault);
		inventoryWarehouseDefault.setInventoryDefinition(this);

		return inventoryWarehouseDefault;
	}

	public InventoryWarehouseDefault removeInventoryWarehouseDefault(InventoryWarehouseDefault inventoryWarehouseDefault) {
		getInventoryWarehouseDefaults().remove(inventoryWarehouseDefault);
		inventoryWarehouseDefault.setInventoryDefinition(null);

		return inventoryWarehouseDefault;
	}

	public Set<InventoryWarehouseDefaultsAudit> getInventoryWarehouseDefaultsAudits() {
		return this.inventoryWarehouseDefaultsAudits;
	}

	public void setInventoryWarehouseDefaultsAudits(Set<InventoryWarehouseDefaultsAudit> inventoryWarehouseDefaultsAudits) {
		this.inventoryWarehouseDefaultsAudits = inventoryWarehouseDefaultsAudits;
	}

	public InventoryWarehouseDefaultsAudit addInventoryWarehouseDefaultsAudit(InventoryWarehouseDefaultsAudit inventoryWarehouseDefaultsAudit) {
		getInventoryWarehouseDefaultsAudits().add(inventoryWarehouseDefaultsAudit);
		inventoryWarehouseDefaultsAudit.setInventoryDefinition(this);

		return inventoryWarehouseDefaultsAudit;
	}

	public InventoryWarehouseDefaultsAudit removeInventoryWarehouseDefaultsAudit(InventoryWarehouseDefaultsAudit inventoryWarehouseDefaultsAudit) {
		getInventoryWarehouseDefaultsAudits().remove(inventoryWarehouseDefaultsAudit);
		inventoryWarehouseDefaultsAudit.setInventoryDefinition(null);

		return inventoryWarehouseDefaultsAudit;
	}

	public Set<ItemBalance> getItemBalances() {
		return this.itemBalances;
	}

	public void setItemBalances(Set<ItemBalance> itemBalances) {
		this.itemBalances = itemBalances;
	}

	public ItemBalance addItemBalance(ItemBalance itemBalance) {
		getItemBalances().add(itemBalance);
		itemBalance.setInventoryDefinition(this);

		return itemBalance;
	}

	public ItemBalance removeItemBalance(ItemBalance itemBalance) {
		getItemBalances().remove(itemBalance);
		itemBalance.setInventoryDefinition(null);
	...
	public ItemTransaction addItemTransaction(ItemTransaction itemTransaction) {
		...
		itemTransaction.setInventoryDefinition(this);
	...
	public ItemTransaction removeItemTransaction(ItemTransaction itemTransaction) {
		...
		itemTransaction.setInventoryDefinition(null);
