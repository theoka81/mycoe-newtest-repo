...
/**
 * The persistent class for the SupplierEnquiryHeaderWorks database table.
 * 
 */
@Entity
@Table(name="SupplierEnquiryHeaderWorks")
@NamedQuery(name="SupplierEnquiryHeaderWork.findAll", query="SELECT s FROM SupplierEnquiryHeaderWork s")
public class SupplierEnquiryHeaderWork implements Serializable {
	...
	public SupplierEnquiryHeaderWork() {
	}
