...
/**
 * The persistent class for the StockReservations database table.
 * 
 */
@Entity
@Table(name="StockReservations")
@NamedQuery(name="StockReservation.findAll", query="SELECT s FROM StockReservation s")
public class StockReservation implements Serializable {
	...
	//bi-directional many-to-one association to StockReservationItem
	@OneToMany(mappedBy="stockReservation")
	private Set<StockReservationItem> stockReservationItems;
	...
	public Set<StockReservationItem> getStockReservationItems() {
		return this.stockReservationItems;
	}

	public void setStockReservationItems(Set<StockReservationItem> stockReservationItems) {
		this.stockReservationItems = stockReservationItems;
	}

	public StockReservationItem addStockReservationItem(StockReservationItem stockReservationItem) {
		getStockReservationItems().add(stockReservationItem);
		stockReservationItem.setStockReservation(this);

		return stockReservationItem;
	}

	public StockReservationItem removeStockReservationItem(StockReservationItem stockReservationItem) {
		getStockReservationItems().remove(stockReservationItem);
		stockReservationItem.setStockReservation(null);
