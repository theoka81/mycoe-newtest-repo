...
/**
 * The persistent class for the ErrorMappings database table.
 * 
 */
@Entity
@Table(name="ErrorMappings")
@NamedQuery(name="ErrorMapping.findAll", query="SELECT e FROM ErrorMapping e")
