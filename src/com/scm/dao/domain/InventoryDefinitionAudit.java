...
/**
 * The persistent class for the InventoryDefinitionAudits database table.
 * 
 */
@Entity
@Table(name="InventoryDefinitionAudits")
@NamedQuery(name="InventoryDefinitionAudit.findAll", query="SELECT i FROM InventoryDefinitionAudit i")
public class InventoryDefinitionAudit implements Serializable {
	...
	public InventoryDefinitionAudit() {
	}
