...
/**
 * The persistent class for the ClauseAudits database table.
 * 
 */
@Entity
@Table(name="ClauseAudits")
@NamedQuery(name="ClauseAudit.findAll", query="SELECT c FROM ClauseAudit c")
public class ClauseAudit implements Serializable {
