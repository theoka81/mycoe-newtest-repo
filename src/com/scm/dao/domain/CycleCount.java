...
/**
 * The persistent class for the CycleCounts database table.
 * 
 */
@Entity
@Table(name="CycleCounts")
@NamedQuery(name="CycleCount.findAll", query="SELECT c FROM CycleCount c")
public class CycleCount implements Serializable {
	...
	public CycleCountDetail addCycleCountDetail(CycleCountDetail cycleCountDetail) {
		...
		cycleCountDetail.setCycleCount(this);
	...
	public CycleCountDetail removeCycleCountDetail(CycleCountDetail cycleCountDetail) {
		...
		cycleCountDetail.setCycleCount(null);
