...
/**
 * The persistent class for the ContractDetailsAudits database table.
 * 
 */
@Entity
@Table(name="ContractDetailsAudits")
@NamedQuery(name="ContractDetailsAudit.findAll", query="SELECT c FROM ContractDetailsAudit c")
public class ContractDetailsAudit implements Serializable {
