...
/**
 * The persistent class for the TenderProcessFlows database table.
 * 
 */
@Entity
@Table(name="TenderProcessFlows")
@NamedQuery(name="TenderProcessFlow.findAll", query="SELECT t FROM TenderProcessFlow t")
public class TenderProcessFlow implements Serializable {
