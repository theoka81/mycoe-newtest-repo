...
public class PreferredCommunicationMethod implements Serializable {
	...
	@Column(name = "PreferredCommunicationMethodId", unique = true, nullable = false)
	private Long preferredCommunicationMethodId;
	...
	public Long getPreferredCommunicationMethodId() {
		return preferredCommunicationMethodId;
	}

	public void setPreferredCommunicationMethodId(Long preferredCommunicationMethodId) {
