...
/**
 * The persistent class for the SupplierCodesWorkAudits database table.
 * 
 */
@Entity
@Table(name="SupplierCodesWorkAudits")
@NamedQuery(name="SupplierCodesWorkAudit.findAll", query="SELECT s FROM SupplierCodesWorkAudit s")
public class SupplierCodesWorkAudit implements Serializable {
