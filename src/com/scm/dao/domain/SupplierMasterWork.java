...
/**
 * The persistent class for the SupplierMasterWorks database table.
 * 
 */
@Entity
@Table(name="SupplierMasterWorks")
@NamedQuery(name="SupplierMasterWork.findAll", query="SELECT s FROM SupplierMasterWork s")
public class SupplierMasterWork implements Serializable {
