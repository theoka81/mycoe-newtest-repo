...
/**
 * The persistent class for the SupplierCodesAudits database table.
 * 
 */
@Entity
@Table(name="SupplierCodesAudits")
@NamedQuery(name="SupplierCodesAudit.findAll", query="SELECT s FROM SupplierCodesAudit s")
public class SupplierCodesAudit implements Serializable {
