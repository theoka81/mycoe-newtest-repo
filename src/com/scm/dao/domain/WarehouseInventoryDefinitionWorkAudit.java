...
/**
 * The persistent class for the WarehouseInventoryDefinitionWorkAudits database table.
 * 
 */
@Entity
@Table(name="WarehouseInventoryDefinitionWorkAudits")
@NamedQuery(name="WarehouseInventoryDefinitionWorkAudit.findAll", query="SELECT w FROM WarehouseInventoryDefinitionWorkAudit w")
public class WarehouseInventoryDefinitionWorkAudit implements Serializable {
	...
	public WarehouseInventoryDefinitionWorkAudit() {
	}
