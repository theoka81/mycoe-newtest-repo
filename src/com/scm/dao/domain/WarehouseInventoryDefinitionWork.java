...
/**
 * The persistent class for the WarehouseInventoryDefinitionWorks database table.
 * 
 */
@Entity
@Table(name="WarehouseInventoryDefinitionWorks")
@NamedQuery(name="WarehouseInventoryDefinitionWork.findAll", query="SELECT w FROM WarehouseInventoryDefinitionWork w")
public class WarehouseInventoryDefinitionWork implements Serializable {
	...
	public WarehouseInventoryDefinitionWork() {
	}
