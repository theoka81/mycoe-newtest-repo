...
/**
 * The persistent class for the StandardCommodityAgreementAudits database table.
 * 
 */
@Entity
@Table(name="StandardCommodityAgreementAudits")
@NamedQuery(name="StandardCommodityAgreementAudit.findAll", query="SELECT s FROM StandardCommodityAgreementAudit s")
public class StandardCommodityAgreementAudit implements Serializable {
	...
	public StandardCommodityAgreementAudit() {
	}
