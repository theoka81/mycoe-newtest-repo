...
/**
 * The persistent class for the ContractStandardsAudits database table.
 * 
 */
@Entity
@Table(name="ContractStandardsAudits")
@NamedQuery(name="ContractStandardsAudit.findAll", query="SELECT c FROM ContractStandardsAudit c")
public class ContractStandardsAudit implements Serializable {
