...
/**
 * The persistent class for the ContractMasterAudits database table.
 * 
 */
@Entity
@Table(name="ContractMasterAudits")
@NamedQuery(name="ContractMasterAudit.findAll", query="SELECT c FROM ContractMasterAudit c")
public class ContractMasterAudit implements Serializable {
	...
	@OneToMany(mappedBy="contractMasterAudit")
	...
	//bi-directional many-to-one association to UserCode
	@ManyToOne
	@JoinColumn(name="ContractHeaderTypeId", nullable=false)
	...
	public ContractDetail addContractDetail(ContractDetail contractDetail) {
		...
		contractDetail.setContractMasterAudit(this);
	...
	public ContractDetail removeContractDetail(ContractDetail contractDetail) {
		...
		contractDetail.setContractMasterAudit(null);
