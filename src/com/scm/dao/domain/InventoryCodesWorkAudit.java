...
/**
 * The persistent class for the InventoryCodesWorkAudits database table.
 * 
 */
@Entity
@Table(name="InventoryCodesWorkAudits")
@NamedQuery(name="InventoryCodesWorkAudit.findAll", query="SELECT i FROM InventoryCodesWorkAudit i")
public class InventoryCodesWorkAudit implements Serializable {
	...
	public InventoryCodesWorkAudit() {
	}
