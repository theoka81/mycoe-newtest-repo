...
/**
 * The persistent class for the InventoryWarehouseDefaultsAudits database table.
 * 
 */
@Entity
@Table(name="InventoryWarehouseDefaultsAudits")
@NamedQuery(name="InventoryWarehouseDefaultsAudit.findAll", query="SELECT i FROM InventoryWarehouseDefaultsAudit i")
public class InventoryWarehouseDefaultsAudit implements Serializable {
	...
	public InventoryWarehouseDefaultsAudit() {
	}
