...
/**
 * The persistent class for the InventoryDefinitionWorkAudits database table.
 * 
 */
@Entity
@Table(name="InventoryDefinitionWorkAudits")
@NamedQuery(name="InventoryDefinitionWorkAudit.findAll", query="SELECT i FROM InventoryDefinitionWorkAudit i")
public class InventoryDefinitionWorkAudit implements Serializable {
	...
	public InventoryDefinitionWorkAudit() {
	}
