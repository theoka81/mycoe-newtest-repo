...
/**
 * The persistent class for the InventoryCodesWorks database table.
 * 
 */
@Entity
@Table(name="InventoryCodesWorks")
@NamedQuery(name="InventoryCodesWork.findAll", query="SELECT i FROM InventoryCodesWork i")
public class InventoryCodesWork implements Serializable {
