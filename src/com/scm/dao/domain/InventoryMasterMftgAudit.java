...
/**
 * The persistent class for the InventoryMasterMftgAudits database table.
 * 
 */
@Entity
@Table(name="InventoryMasterMftgAudits")
@NamedQuery(name="InventoryMasterMftgAudit.findAll", query="SELECT i FROM InventoryMasterMftgAudit i")
public class InventoryMasterMftgAudit implements Serializable {
	...
	public InventoryMasterMftgAudit() {
	}
