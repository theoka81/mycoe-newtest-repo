...
/**
 * The persistent class for the SupplierCompliantHeaderWorks database table.
 * 
 */
@Entity
@Table(name="SupplierCompliantHeaderWorks")
@NamedQuery(name="SupplierCompliantHeaderWork.findAll", query="SELECT s FROM SupplierCompliantHeaderWork s")
public class SupplierCompliantHeaderWork implements Serializable {
	...
	public SupplierCompliantHeaderWork() {
	}
