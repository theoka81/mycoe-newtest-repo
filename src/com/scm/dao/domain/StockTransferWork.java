...
/**
 * The persistent class for the StockTransferWorks database table.
 * 
 */
@Entity
@Table(name="StockTransferWorks")
@NamedQuery(name="StockTransferWork.findAll", query="SELECT s FROM StockTransferWork s")
public class StockTransferWork implements Serializable {
