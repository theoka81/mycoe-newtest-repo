...
@Repository
public class HibernateAddressTypesDao extends HibernateGenericDao<AddressType, Integer>
	...
	public AddressType getAddressTypeByCode(String code) throws Throwable {
		...
		List<AddressType> result = crit.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY).list();
		if (result.size() >= 1) {
			return result.get(0);
		} else {
			return null;
