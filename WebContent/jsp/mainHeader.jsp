...
<link href="../Icons/pe-icon-7-stroke/css/pe-icon-7-stroke.css"
	rel="stylesheet" />
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				...
				<form action="../Account/LogOff" class="navbar-right"
					id="logoutForm" method="post">
					<input name="__RequestVerificationToken" type="hidden"
						value="IkbAbmkw11gHL4Gcmge5rPSVnEI1B_dxmr_tHuE5UDT4E4GuIQy7XZMF1rcn17p_uQSTeV0dsHwq6svYxYSRResNLIHOtBXWjHuuMv0MtA9mw47vJPxdMmTkzVOubu3ltsbpyEEgd_yETxzZWISAgA2" />
					<ul class="nav navbar-nav navbar-right">
						<li><a href="../Manage" title="Manage">Hello <s:property
									value="%{#session['SESSION_USER_NAME']}" />...!
						</a></li>
						...
						<li class="top-level-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown" title="Help Desk"><i
								class="pe-7s-upload pe-7s-help1" style="font-size: 25px"></i></a>
							<ul class="dropdown-menu">
								<li><a href="../SupportQueries">My Query History</a></li>
							</ul></li>
						<li><a data-toggle="modal" data-target="#queryModal"
							title="Support Queries"> <i class="pe-7s-chat"
								style="font-size: 25px"></i>
						</a></li>
						<li><a href="../Account/EditUserInfo"
							title="My Profile Information"> <i class="pe-7s-user"
								style="font-size: 25px"></i>
						</a></li>
						<li><a
							href="javascript:document.getElementById('logoutForm').submit()"
							title="Logout of your account"> <i class="pe-7s-power"
								style="font-size: 25px"></i>
						</a></li>
					</ul>
				</form>
...
/*
    .longInput {
        width: 540px;
				...
				<form action="../SupplierMaster/Index/21422" method="post">
					<input name="__RequestVerificationToken" type="hidden"
						value="blI3TV-kEJAkt0gnps8BT4Qvsj7qNyrMLAalZMlKMKLArvCkjAwQWTpAKU4KXPprm0hsAUMKEH4l1v3ZxKXYFeeUK0oZ3OAwyunzwykWyKFkDbuVjioFfVJObcPwWGy9yKCxQp5mUPDVMykKNOqtLA2" />
									...
									<div id="SucessContent" hidden>
										<div class="text-center">
											...
											<b style="font-size: 12px">Your Query has been
												successfully forwarded to support , hang tight they will get
												back to you as soon as possible...</b> <br />
									...
									<div id="errorContent" hidden>
										<div class="text-center">
											...
											<b style="font-size: 12px">Oops Something went wrong ,
												please try again or contact support if this error persists..</b>
											<br />
